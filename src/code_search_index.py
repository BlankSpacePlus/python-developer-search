...
class SearchEngine:
    ...
    def create_index(self):
        ...
        try:
            print(self.es.indices.create(index=self.index_name, body=body))
        ...
        for i in range(10):
            for j in range(20):
                ...
                if os.path.exists(file):
                    body = code_matcher_utils.load_pkl(file)
                    ...
                    print()
                    code_matcher_utils.save_pkl(path + 'data' + str(idx) + '.pkl', body)
                    idx += 1
                else:
                    break
        ...
        for i in range(1):  # 166
            ...
            for j in range(len(data)):
                ...
                if not hash_set.__contains__(hash_val):
                    ...
                    body.append(data[j])
                print()
            code_matcher_utils.save_pkl(path + 'body' + str(i) + '.pkl', body)
            print()
    ...
    def clean_data(self, path):
        for i in range(1):  # 166
            ...
            for j in range(len(data)):
                ...
                if flag == 0:
                    body.append(data[j])
            code_matcher_utils.save_pkl(path + 'data' + str(i) + '.pkl', body)
